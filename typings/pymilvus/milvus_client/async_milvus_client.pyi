...
from pymilvus.client.abstract import AnnSearchRequest as AnnSearchRequest
...
from pymilvus.client.types import ExceptionsMessage as ExceptionsMessage
from pymilvus.client.types import OmitZeroDict as OmitZeroDict
from pymilvus.client.types import ResourceGroupConfig as ResourceGroupConfig
from pymilvus.client.types import RoleInfo as RoleInfo
from pymilvus.client.types import UserInfo as UserInfo
...
from pymilvus.orm.collection import CollectionSchema as CollectionSchema
...
from .index import IndexParam as IndexParam
...
class AsyncMilvusClient:
    ...
    async def rename_collection(
        self, old_name: str, new_name: str, target_db: str | None = "", timeout: float | None = None, **kwargs
    ): ...
    ...
    async def create_index(
        self, collection_name: str, index_params: IndexParams, timeout: float | None = None, **kwargs
    ): ...
    async def drop_index(self, collection_name: str, index_name: str, timeout: float | None = None, **kwargs): ...
    ...
    async def load_partitions(
        self, collection_name: str, partition_names: str | list[str], timeout: float | None = None, **kwargs
    ): ...
    ...
    async def describe_collection(self, collection_name: str, timeout: float | None = None, **kwargs) -> dict: ...
    ...
    async def get_collection_stats(self, collection_name: str, timeout: float | None = None, **kwargs) -> dict: ...
    ...
    async def describe_replica(self, collection_name: str, timeout: float | None = None, **kwargs): ...
    ...
    async def alter_collection_field(
        self, collection_name: str, field_name: str, field_params: dict, timeout: float | None = None, **kwargs
    ): ...
    ...
    async def list_indexes(self, collection_name: str, field_name: str | None = "", **kwargs): ...
    ...
    async def describe_alias(self, alias: str, timeout: float | None = None, **kwargs) -> dict: ...
    async def list_aliases(self, collection_name: str = "", timeout: float | None = None, **kwargs) -> list[str]: ...
    def using_database(self, db_name: str, **kwargs): ...
    def use_database(self, db_name: str, **kwargs): ...
    async def create_database(
        self, db_name: str, properties: dict | None = None, timeout: float | None = None, **kwargs
    ): ...
    async def drop_database(self, db_name: str, **kwargs): ...
    async def list_databases(self, timeout: float | None = None, **kwargs) -> list[str]: ...
    ...
    async def create_user(self, user_name: str, password: str, timeout: float | None = None, **kwargs): ...
    async def drop_user(self, user_name: str, timeout: float | None = None, **kwargs): ...
    async def update_password(
        self, user_name: str, old_password: str, new_password: str, timeout: float | None = None, **kwargs
    ): ...
    async def list_users(self, timeout: float | None = None, **kwargs) -> list[str]: ...
    async def describe_user(self, user_name: str, timeout: float | None = None, **kwargs) -> dict: ...
    async def create_privilege_group(self, group_name: str, timeout: float | None = None, **kwargs): ...
    async def drop_privilege_group(self, group_name: str, timeout: float | None = None, **kwargs): ...
    async def list_privilege_groups(
        self, timeout: float | None = None, **kwargs
    ) -> list[dict[str, str | list[str]]]: ...
    async def add_privileges_to_group(
        self, group_name: str, privileges: list[str], timeout: float | None = None, **kwargs
    ): ...
    ...
    async def grant_role(self, user_name: str, role_name: str, timeout: float | None = None, **kwargs): ...
    async def revoke_role(self, user_name: str, role_name: str, timeout: float | None = None, **kwargs): ...
    ...
    async def describe_role(self, role_name: str, timeout: float | None = None, **kwargs) -> dict: ...
    async def list_roles(self, timeout: float | None = None, **kwargs): ...
    ...
    async def update_resource_groups(
        self, configs: dict[str, ResourceGroupConfig], timeout: float | None = None, **kwargs
    ): ...
    async def describe_resource_group(self, name: str, timeout: float | None = None, **kwargs): ...
    async def list_resource_groups(self, timeout: float | None = None, **kwargs) -> list[str]: ...
    ...
    async def get_compaction_state(self, job_id: int, timeout: float | None = None, **kwargs) -> str: ...
